...
const CategoryCard = ({ category }) => {
  ...
  return (
    ...
    >
      <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-button bg-slate-100 flex items-center justify-center mb-2.5 sm:mb-3">
        <img src={category.icon} alt="" className="h-5 w-5 sm:h-6 sm:w-6" />
      </div>
