const HeroSection = () => {
  return (
    <div className="mx-auto max-w-3xl text-center flex flex-col items-center min-h-[80vh] justify-center">
        ...
        <span className="text-xs border border-primary-hover border-dashed bg-green-100 text-primary px-2 py-1 rounded-xl">Master Technical Concepts</span>
        <p className="text-5xl mt-3 tracking-tight">Practice smarter with curated quizzes built for
