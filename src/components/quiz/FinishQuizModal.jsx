const FinishQuizModal = ({ attemptedQuestions, totalQuestions, onClose, onFinish }) => {
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center px-4 z-50">
      <div className="bg-background rounded-card p-5 sm:p-6 w-full max-w-sm">
        <h2 className="text-base sm:text-lg font-semibold text-text mb-2">Finish quiz?</h2>
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2">
          ...
          <button
            onClick={onFinish}
            className="px-4 py-2.5 sm:py-2 rounded-button bg-primary text-background text-sm font-medium hover:bg-primary-hover transition-all duration-200 cursor-pointer"
          >
            Finish quiz
          </button>
        </div>
