const reactFormsEventsQuestions = [
  {
    ...
    options: [
      { id: "A", text: "An input that cannot be changed by the user." },
      { id: "B", text: "An input controlled only by CSS." },
      { id: "C", text: "An input whose current value is controlled by React state." },
      { id: "D", text: "An input whose value is stored automatically in localStorage." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "<input value={name} />" },
      { id: "B", text: "<input state={name} onChange={setName} />" },
      { id: "C", text: "<input controlled={name} />" },
      { id: "D", text: "<input value={name} onChange={e => setName(e.target.value)} />" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The input's current text value." },
      { id: "B", text: "The input's React state setter." },
      { id: "C", text: "The component's props object." },
      { id: "D", text: "The browser's current URL." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "onInputChange" },
      { id: "B", text: "onChange" },
      { id: "C", text: "changeHandler" },
      { id: "D", text: "onValueChangeOnly" }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "To update every input automatically." },
      { id: "B", text: "To validate CSS." },
      { id: "C", text: "To handle the form's submission event." },
      { id: "D", text: "To create a new React component." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "To prevent React from rendering the form." },
      { id: "B", text: "To clear every form field." },
      { id: "C", text: "To stop the submit handler from running." },
      { id: "D", text: "To prevent the browser's default form submission behavior." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "<button onClick={handleClick}>Save</button>" },
      { id: "B", text: "<button click={handleClick}>Save</button>" },
      { id: "C", text: "<button on-click={handleClick}>Save</button>" },
      { id: "D", text: "<button event={handleClick}>Save</button>" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "React does not allow functions as event handlers." },
      { id: "B", text: "handleSave is called while rendering instead of when the button is clicked." },
      { id: "C", text: "Buttons cannot have click events in React." },
      { id: "D", text: "Parentheses are invalid in JSX." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "<button onClick={deleteItem(item.id)}>Delete</button>" },
      { id: "B", text: "<button onClick={item.id}>Delete</button>" },
      { id: "C", text: "<button onClick={() => deleteItem(item.id)}>Delete</button>" },
      { id: "D", text: "<button click={() => deleteItem(item.id)}>Delete</button>" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "It submits the form automatically." },
      { id: "B", text: "It prevents all keyboard input." },
      { id: "C", text: "It changes the input's CSS." },
      { id: "D", text: "It synchronizes the React state with the user's current input." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "React state becomes the source of truth for the input value." },
      { id: "B", text: "The browser can no longer change the input." },
      { id: "C", text: "The input no longer needs an event handler." },
      { id: "D", text: "The input is automatically stored on the server." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "The input automatically updates the state." },
      { id: "B", text: "The input is effectively read-only because React keeps assigning the state value." },
      { id: "C", text: "React converts the input into an uncontrolled input." },
      { id: "D", text: "The value prop is ignored." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "<label forInput=\"email\">Email</label><input name=\"email\" />" },
      { id: "B", text: "<label id=\"email\">Email</label><input label=\"email\" />" },
      { id: "C", text: "<label input=\"email\">Email</label><input id=\"other\" />" },
      { id: "D", text: "<label htmlFor=\"email\">Email</label><input id=\"email\" />" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "event.target.valueChecked" },
      { id: "B", text: "event.checked.target" },
      { id: "C", text: "event.value.checked" },
      { id: "D", text: "event.target.checked" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "checked represents whether it is selected, while value represents its associated value." },
      { id: "B", text: "checked always contains the user's name." },
      { id: "C", text: "value is always a boolean and checked is always a string." },
...

  {
    ...
    options: [
      { id: "A", text: "The number of options in the dropdown." },
      { id: "B", text: "The currently selected option's value." },
      { id: "C", text: "The text of every option combined." },
      { id: "D", text: "The React component's state object." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "<select selected={role} onChange={setRole}>...</select>" },
      { id: "B", text: "<select state={role}>...</select>" },
      { id: "C", text: "<select value={role} onChange={e => setRole(e.target.value)}>...</select>" },
      { id: "D", text: "<select valueState={role}>...</select>" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "It automatically creates React state." },
      { id: "B", text: "It makes the input required." },
      { id: "C", text: "It assigns a CSS class." },
      { id: "D", text: "It identifies the control's field name in form data and can also be used by browser form behavior." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The browser should require a value before allowing normal form submission." },
      { id: "B", text: "React will automatically create a state variable." },
      { id: "C", text: "The field will always contain a value." },
      { id: "D", text: "The field becomes read-only." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It automatically sends data to a React state variable." },
      { id: "B", text: "It makes the button a submit control for the form." },
      { id: "C", text: "It prevents form submission." },
      { id: "D", text: "It turns the button into a checkbox." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "onSubmit only works with mouse clicks." },
      { id: "B", text: "Buttons cannot have onClick handlers." },
      { id: "C", text: "The form's submit event also handles submission triggered through keyboard interaction." },
      { id: "D", text: "React does not support form-level events." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "It prevents the handler from running." },
      { id: "B", text: "It reloads the page before logging." },
      { id: "C", text: "It clears every input automatically." },
      { id: "D", text: "It prevents the default browser submission and logs submitted." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "function handleSubmit(e) { e.preventDefault(); console.log(email); }" },
      { id: "B", text: "function handleSubmit(e) { e.preventDefault(); console.log(e.email); }" },
      { id: "C", text: "function handleSubmit(e) { console.log(e.state.email); }" },
      { id: "D", text: "function handleSubmit(e) { console.log(form.email.state); }" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Modify the input's DOM value directly and ignore state." },
      { id: "B", text: "Read the current state value, validate it, and submit only when it satisfies the required rules." },
      { id: "C", text: "Always submit first and validate later." },
      { id: "D", text: "Disable React rendering while validation runs." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Throw a JavaScript exception for every invalid keystroke." },
      { id: "B", text: "Modify the browser's DOM manually after every render." },
      { id: "C", text: "Keep validation information in state or derive it from the current input state and render an error message conditionally." },
      { id: "D", text: "Store the error only in a CSS selector." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "React validation is never executed." },
      { id: "B", text: "Browsers cannot validate strings." },
      { id: "C", text: "Server validation is only needed for CSS." },
      { id: "D", text: "Client-side validation can be bypassed, so the server must enforce its own rules." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "A SyntheticEvent" },
      { id: "B", text: "A ReactStateEvent" },
      { id: "C", text: "A ComponentEventOnly" },
      { id: "D", text: "A BrowserStateObject" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It replaces JavaScript event handling entirely." },
      { id: "B", text: "It provides a consistent event interface for React event handlers." },
      { id: "C", text: "It only works for keyboard events." },
      { id: "D", text: "It prevents events from reaching the browser." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Always the deepest element that initiated the event." },
      { id: "B", text: "The React component function." },
      { id: "C", text: "The element on which the current event handler is registered." },
      { id: "D", text: "The current state object." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "target always refers to React state, while currentTarget refers to props." },
      { id: "B", text: "They always refer to different elements." },
      { id: "C", text: "currentTarget only exists for form events." },
      { id: "D", text: "target is the original event target, while currentTarget is the element currently handling the event." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It prevents the event from continuing through the propagation path." },
      { id: "B", text: "It prevents the browser's default action." },
      { id: "C", text: "It clears React state." },
      { id: "D", text: "It stops the event handler itself from executing." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "They always do exactly the same thing." },
      { id: "B", text: "preventDefault stops the default browser action, while stopPropagation controls event propagation." },
      { id: "C", text: "preventDefault changes React state, while stopPropagation changes props." },
      { id: "D", text: "stopPropagation submits the form while preventDefault cancels it." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Only the parent handler can ever run." },
      { id: "B", text: "React automatically stops propagation for every click." },
      { id: "C", text: "The click can bubble from the button to the parent." },
      { id: "D", text: "The browser reloads the page." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Enter always calls every JavaScript function on the page." },
      { id: "B", text: "React treats Enter as a mouse click." },
      { id: "C", text: "Text inputs cannot receive keyboard events." },
      { id: "D", text: "Pressing Enter can submit a form when the form has an appropriate submit mechanism." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "onKeyDown" },
      { id: "B", text: "onKeyboard" },
      { id: "C", text: "keyboardEvent" },
      { id: "D", text: "onKeyPressOnly" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "The React state setter." },
      { id: "B", text: "The key value associated with the keyboard event, such as Enter or Escape." },
      { id: "C", text: "The input's CSS class." },
      { id: "D", text: "The form's validation result." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "The browser permanently stores the user's raw input." },
      { id: "B", text: "The onChange event's original value is always displayed." },
      { id: "C", text: "The value supplied to the input from the latest React state." },
      { id: "D", text: "React ignores the value prop after the first render." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "React cannot render uppercase strings." },
      { id: "B", text: "onChange cannot update state." },
      { id: "C", text: "The input automatically becomes uncontrolled." },
      { id: "D", text: "The displayed value is transformed to uppercase on each render, which may make normal typing behavior surprising." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It can group related form data into one logical state value." },
      { id: "B", text: "React requires all form fields to share one state object." },
      { id: "C", text: "It prevents every input from needing an onChange handler." },
      { id: "D", text: "It automatically validates all fields." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "setForm(form.email = e.target.value)" },
      { id: "B", text: "setForm(prev => ({ ...prev, email: e.target.value }))" },
      { id: "C", text: "form.email = e.target.value" },
      { id: "D", text: "setForm({ email: e.target.value })" }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "React cannot store strings in objects." },
      { id: "B", text: "setForm only accepts functions." },
      { id: "C", text: "It replaces the entire form state object and can discard other fields." },
      { id: "D", text: "The email value will always become undefined." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Store all fields in localStorage on every keystroke." },
      { id: "B", text: "Use one state variable for every character." },
      { id: "C", text: "Remove the name attributes." },
      { id: "D", text: "Use the input's name attribute and a shared change handler that updates the corresponding state property." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "const { name, type, value, checked } = e.target; setForm(prev => ({ ...prev, [name]: type === \"checkbox\" ? checked : value }));" },
      { id: "B", text: "setForm(prev => ({ [e.target.name]: e.target.value }));" },
      { id: "C", text: "setForm(e.target.checked);" },
      { id: "D", text: "setForm(prev => ({ ...prev, value: checked }));" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It prevents inputs from receiving changes." },
      { id: "B", text: "It provides one place to validate, prevent default behavior, and process the form data." },
      { id: "C", text: "It automatically sends the data to every API." },
      { id: "D", text: "It makes all form fields uncontrolled." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Reload the page, then read the React state." },
      { id: "B", text: "Submit invalid data first and validate it afterward." },
      { id: "C", text: "Prevent default submission, validate the current data, submit valid data, then handle the result." },
      { id: "D", text: "Ignore the submit event and rely only on button styling." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Controlled inputs cannot be submitted." },
      { id: "B", text: "React does not support password inputs." },
      { id: "C", text: "onSubmit only works with checkboxes." },
      { id: "D", text: "The submit handler did not call event.preventDefault(), so the browser performed its default form submission." }
    ],
    correctOptionId: "D",
