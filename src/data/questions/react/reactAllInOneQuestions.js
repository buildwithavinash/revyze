const reactAllInOneQuestions = [
  {
    ...
    options: [
      { id: "A", text: "To write UI structure using a syntax that resembles HTML inside JavaScript." },
      { id: "B", text: "To replace JavaScript with HTML in React components." },
      { id: "C", text: "To automatically manage component state." },
      { id: "D", text: "To create CSS styles without external stylesheets." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "To directly modify the component's internal state." },
      { id: "B", text: "To pass data from a parent component to a child component." },
      { id: "C", text: "To force a component to render on every event." },
      { id: "D", text: "To store data permanently in the browser." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Static information passed only through HTML attributes." },
      { id: "B", text: "Data that can only be changed by modifying props." },
      { id: "C", text: "Data that can change over time and trigger a component re-render when updated through React." },
      { id: "D", text: "Browser storage that remains available after the application closes." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "The browser immediately executes Hello as JavaScript." },
      { id: "B", text: "React creates a new state variable named Hello." },
      { id: "C", text: "The component returns a string containing the literal JSX source code." },
      { id: "D", text: "The component returns a React element describing an h1 element containing Hello." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "They give React a stable identity for each item when reconciling the list." },
      { id: "B", text: "They prevent every list item from receiving props." },
      { id: "C", text: "They automatically sort the list alphabetically." },
      { id: "D", text: "They convert an array into a React state variable." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Modify the state variable directly before calling the setter." },
      { id: "B", text: "Store the previous state in localStorage first." },
      { id: "C", text: "Use the functional updater form of the state setter." },
      { id: "D", text: "Force the component to unmount and mount again." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "It creates a state variable named name inside User." },
      { id: "B", text: "It passes name from User back to App." },
      { id: "C", text: "It creates a context value named Avi." },
      { id: "D", text: "It passes the string Avi to User through a prop named name." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "To perform side effects associated with rendering and state or prop changes." },
      { id: "B", text: "To replace every use of useState." },
      { id: "C", text: "To create CSS classes dynamically." },
      { id: "D", text: "To define routes without a router." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "The effect runs after every state update." },
      { id: "B", text: "The effect does not depend on any reactive values declared for the effect." },
      { id: "C", text: "The effect can never run." },
      { id: "D", text: "The effect automatically receives every prop." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "{users.forEach(user => <li>{user.name}</li>)}" },
      { id: "B", text: "{users.filter(user => <li>{user.name}</li>)}" },
      { id: "C", text: "{users.map(user => <li key={user.id}>{user.name}</li>)}" },
      { id: "D", text: "{users.reduce(user => <li>{user.name}</li>)}" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "React only allows objects to contain strings." },
      { id: "B", text: "React automatically freezes every object permanently." },
      { id: "C", text: "Objects cannot be stored in React state." },
      { id: "D", text: "It changes the existing object instead of creating a new state value for the update." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Props are inputs received by a component, while state is data managed by the component." },
      { id: "B", text: "Props can only contain strings, while state can only contain numbers." },
      { id: "C", text: "Props always change automatically, while state never changes." },
      { id: "D", text: "Props are browser data, while state is server data." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It prevents all components from rendering." },
      { id: "B", text: "It lets multiple components share state by moving the state to their nearest appropriate common parent." },
      { id: "C", text: "It automatically stores state in a database." },
      { id: "D", text: "It eliminates the need for props in every component." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "An input that cannot receive user interaction." },
      { id: "B", text: "An input controlled only by the browser's URL." },
      { id: "C", text: "An input whose current value is controlled by React state." },
      { id: "D", text: "An input whose value can only be changed with CSS." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "To replace useState for every state update." },
      { id: "B", text: "To automatically fetch data from an API." },
      { id: "C", text: "To create a new React component." },
      { id: "D", text: "To hold a mutable value or reference that persists across renders without itself causing a re-render when changed." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It allows values to be made available to descendant components without passing them through every intermediate component." },
      { id: "B", text: "It permanently stores data on the user's device." },
      { id: "C", text: "It prevents descendant components from rendering." },
      { id: "D", text: "It replaces React state in every application." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Caching every API response automatically." },
      { id: "B", text: "Skipping a component re-render when its props have not changed according to React's memoization comparison." },
      { id: "C", text: "Preventing state updates inside a component." },
      { id: "D", text: "Making every component render only once." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "To guarantee that List never renders again." },
      { id: "B", text: "To make filtering asynchronous." },
      { id: "C", text: "To cache the filtered result until items or query changes." },
      { id: "D", text: "To move the filtering operation to the server." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "It guarantees the callback executes only once." },
      { id: "B", text: "It automatically makes the callback asynchronous." },
      { id: "C", text: "It prevents the callback from accessing component state." },
      { id: "D", text: "It can preserve the callback reference between renders until its dependencies change." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "To display different application views based on the current URL without requiring a full page reload for every navigation." },
      { id: "B", text: "To replace React components with server-side HTML permanently." },
      { id: "C", text: "To store component state in the URL automatically." },
      { id: "D", text: "To prevent users from navigating between views." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Place the fetch call directly inside the JSX markup." },
      { id: "B", text: "Use an effect whose dependencies include the ID used by the request." },
      { id: "C", text: "Change the component's props directly after the request." },
      { id: "D", text: "Use CSS to trigger the network request." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "To convert React components into CSS files." },
      { id: "B", text: "To eliminate JavaScript from the application." },
      { id: "C", text: "To load JavaScript in smaller chunks so users do not necessarily download the entire application upfront." },
      { id: "D", text: "To guarantee that every component renders faster." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Create another subscription every time the component unmounts." },
      { id: "B", text: "Store the subscription in JSX." },
      { id: "C", text: "Disable React state updates globally." },
      { id: "D", text: "Remove the subscription in the effect cleanup function." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Complex interfaces can be built by combining smaller components and passing data or content between them." },
      { id: "B", text: "Every application must use exactly one component." },
      { id: "C", text: "Components can only communicate through global variables." },
      { id: "D", text: "Composition requires every component to share the same state." }
    ],
    correctOptionId: "A",
  ...
  },
   {
    ...
    options: [
      { id: "A", text: "Rendering every component regardless of application state." },
      { id: "B", text: "Rendering different UI based on a condition in the component's logic." },
      { id: "C", text: "Changing CSS only when the browser window is resized." },
      { id: "D", text: "Rendering components only after they receive a ref." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Only Dashboard" },
      { id: "B", text: "Both Dashboard and Login" },
      { id: "C", text: "Only Login" },
      { id: "D", text: "Neither component" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "onClick={handleDelete(item.id)}" },
      { id: "B", text: "onClick={handleDelete => item.id}" },
      { id: "C", text: "onClick={item.id => handleDelete}" },
      { id: "D", text: "onClick={() => handleDelete(item.id)}" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "To prevent the browser's default form submission behavior." },
      { id: "B", text: "To prevent React state from being updated." },
      { id: "C", text: "To automatically validate every input." },
      { id: "D", text: "To stop the submit handler from executing." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Updating props directly inside a child component." },
      { id: "B", text: "Passing data through intermediate components that do not otherwise need the data." },
      { id: "C", text: "Removing props from a component tree." },
      { id: "D", text: "Passing state only through React Context." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "React.memo ignores all object props." },
      { id: "B", text: "React.memo only works with string props." },
      { id: "C", text: "The object has a new reference on each parent render." },
      { id: "D", text: "Child components cannot receive objects as props." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "useMemo memoizes components, while useCallback memoizes state." },
      { id: "B", text: "useMemo handles effects, while useCallback handles routing." },
      { id: "C", text: "They are identical APIs with different names." },
      { id: "D", text: "useMemo memoizes a calculated value, while useCallback memoizes a function reference." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It represents content nested between a component's opening and closing tags." },
      { id: "B", text: "It contains only the component's internal state." },
      { id: "C", text: "It automatically contains every child component in the application." },
      { id: "D", text: "It is used only for rendering HTML forms." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "A special class that replaces function components." },
      { id: "B", text: "A reusable function that uses React Hooks to share stateful logic between components." },
      { id: "C", text: "A browser API for creating custom DOM events." },
      { id: "D", text: "A React component that cannot accept props." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Hooks can only be executed by the browser." },
      { id: "B", text: "Hooks cannot contain JavaScript expressions." },
      { id: "C", text: "React relies on a consistent Hook call order between renders." },
      { id: "D", text: "React automatically converts top-level Hooks into props." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "The previous connection remains permanently active." },
      { id: "B", text: "React automatically converts the connection into state." },
      { id: "C", text: "The new effect runs without any relationship to the previous cleanup." },
      { id: "D", text: "The previous effect cleanup runs before the effect is synchronized with the new roomId." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The identity of an item remains stable even when the list order changes." },
      { id: "B", text: "React automatically creates the database record." },
      { id: "C", text: "The ID prevents the item from ever being removed." },
      { id: "D", text: "The ID makes the component state global." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Indexes cannot be numbers in JavaScript." },
      { id: "B", text: "The same index can refer to a different logical item after the list changes." },
      { id: "C", text: "React does not allow arrays to be rendered." },
      { id: "D", text: "Index keys automatically sort the list." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "To store React state permanently." },
      { id: "B", text: "To replace component props completely." },
      { id: "C", text: "To represent dynamic values within a URL path." },
      { id: "D", text: "To define CSS breakpoints." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "They prevent child components from rendering." },
      { id: "B", text: "They eliminate the need for URL paths." },
      { id: "C", text: "They make every route globally accessible without configuration." },
      { id: "D", text: "They allow route structures to reflect nested UI layouts and shared parent views." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Memoize the calculated result with useMemo using the relevant inputs as dependencies." },
      { id: "B", text: "Move the calculation into a CSS class." },
      { id: "C", text: "Replace every state variable with a ref." },
      { id: "D", text: "Call the calculation twice so React can cache it." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Memoization guarantees that a component renders exactly once." },
      { id: "B", text: "Memoization is an optimization technique and should not be assumed to eliminate every render." },
      { id: "C", text: "Memoization automatically makes network requests faster." },
      { id: "D", text: "Memoization prevents state changes from working." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "React refuses to pass primitive props." },
      { id: "B", text: "The string is automatically converted into component state." },
      { id: "C", text: "The child receives the new prop value during the resulting render." },
      { id: "D", text: "The child can only receive the value through Context." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Always duplicate the value in another state variable." },
      { id: "B", text: "Store every derived value in localStorage." },
      { id: "C", text: "Update the derived value only when the user refreshes the page." },
      { id: "D", text: "Calculate the value during rendering when it can be derived directly from current props or state." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It introduces an unnecessary synchronization step for a value that could be calculated directly." },
      { id: "B", text: "Effects cannot access props." },
      { id: "C", text: "React prevents effects from running after rendering." },
      { id: "D", text: "Props automatically become immutable only inside effects." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It guarantees that no component will ever re-render." },
      { id: "B", text: "It can reduce unnecessary data flow and keep state ownership easier to understand." },
      { id: "C", text: "It eliminates all need for component composition." },
      { id: "D", text: "It automatically converts local state into global state." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Replacing every local component state variable." },
      { id: "B", text: "Performing CSS calculations." },
      { id: "C", text: "Making application-wide or subtree-wide configuration available to many descendants." },
      { id: "D", text: "Making every network request automatically." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Context values can only contain strings." },
      { id: "B", text: "Context prevents components from receiving props." },
      { id: "C", text: "Context always creates a new browser tab." },
      { id: "D", text: "Changes to a context value can cause consuming components to update, so broad contexts can increase the affected rendering area." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Delay loading a component's code until it is needed." },
      { id: "B", text: "Prevent the component from ever rendering." },
      { id: "C", text: "Convert the component into server-side state." },
      { id: "D", text: "Automatically remove unused CSS from the component." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It catches every possible JavaScript error from every asynchronous operation." },
      { id: "B", text: "It can catch certain rendering errors in descendant components and display fallback UI." },
      { id: "C", text: "It prevents all React components from throwing errors." },
      { id: "D", text: "It replaces try/catch for every JavaScript operation." }
    ],
    correctOptionId: "B",
