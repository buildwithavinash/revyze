const reactRoutingQuestions = [
...

  {
    ...
    options: [
      { id: "A", text: "It stores every React state variable." },
      { id: "B", text: "It replaces the JavaScript runtime." },
      { id: "C", text: "It coordinates the current URL with the UI that should be rendered." },
...

  {
    ...
    options: [
      { id: "A", text: "BrowserState" },
      { id: "B", text: "RouteBrowser" },
      { id: "C", text: "URLProviderOnly" },
      { id: "D", text: "BrowserRouter" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "<Routes><BrowserRouter path=\"/about\"><About /></BrowserRouter></Routes>" },
      { id: "B", text: "<Route path=\"/about\"><BrowserRouter /></Route>" },
      { id: "C", text: "<BrowserRouter><Routes><Route path=\"/about\" element={<About />} /></Routes></BrowserRouter>" },
      { id: "D", text: "<BrowserRouter path=\"/about\"><RouteList /></BrowserRouter>" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "To create database relationships." },
      { id: "B", text: "To reload the entire page after every click." },
      { id: "C", text: "To define nested route parameters." },
      { id: "D", text: "To navigate between routes using a router-aware link." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "A route that only matches the literal text :id." },
      { id: "B", text: "A route containing a dynamic URL parameter named id." },
...

  {
    ...
    options: [
      { id: "A", text: "useRouteValue" },
      { id: "B", text: "usePathState" },
      { id: "C", text: "useParams" },
...

  {
    ...
    options: [
      { id: "A", text: "42 as a number automatically." },
      { id: "B", text: "\"id\"" },
      { id: "C", text: "undefined because route parameters are not supported." },
      { id: "D", text: "\"42\"" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Defining the component's CSS color." },
      { id: "B", text: "Navigating to a dashboard after a successful login." },
...

  {
    ...
    options: [
      { id: "A", text: "They are exactly the same syntax." },
      { id: "B", text: "Query parameters can only contain numbers." },
      { id: "C", text: "A path parameter is part of the route pattern, while a query parameter appears after ? in the URL." },
...

  {
    ...
    options: [
      { id: "A", text: "useQueryValues" },
      { id: "B", text: "useURLParamsOnly" },
      { id: "C", text: "useQueryRoute" },
      { id: "D", text: "useSearchParams" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Creating multiple React roots on the same page." },
      { id: "B", text: "Defining child routes within a parent route hierarchy." },
...

  {
    ...
    options: [
      { id: "A", text: "ChildRoute" },
      { id: "B", text: "NestedView" },
      { id: "C", text: "Outlet" },
...

  {
    ...
    options: [
      { id: "A", text: "/settings/dashboard" },
      { id: "B", text: "/dashboard" },
      { id: "C", text: "/settings" },
      { id: "D", text: "/dashboard/settings" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Preventing all child routes from rendering." },
      { id: "B", text: "Sharing UI such as navigation and sidebars across multiple child routes." },
...

  {
    ...
    options: [
      { id: "A", text: "A route that always appears at /index." },
      { id: "B", text: "A route used only for databases." },
      { id: "C", text: "A child route that renders at the parent's URL by default." },
...

  {
    ...
    options: [
      { id: "A", text: "It forces /dashboard to become /settings." },
      { id: "B", text: "It disables nested routing." },
      { id: "C", text: "It removes the dashboard layout." },
      { id: "D", text: "It can render Overview when the user visits /dashboard without explicitly navigating to /dashboard/overview." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Hide the dashboard with CSS only." },
      { id: "B", text: "Render the dashboard for authenticated users and navigate or redirect unauthenticated users to login." },
...

  {
    ...
    options: [
      { id: "A", text: "React Router automatically exposes every database password." },
      { id: "B", text: "BrowserRouter disables HTTPS." },
      { id: "C", text: "A user can bypass UI routing and directly call backend APIs, so authorization must also be enforced on the server." },
...

  {
    ...
    options: [
      { id: "A", text: "Moves to route parameter -1." },
      { id: "B", text: "Reloads the page exactly once." },
      { id: "C", text: "Navigates to /-1." },
      { id: "D", text: "Moves backward one entry in the browser history." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The destination must always start with https://." },
      { id: "B", text: "The destination can be interpreted relative to the current route hierarchy." },
...

  {
    ...
    options: [
      { id: "A", text: "NavLink can only navigate to external websites." },
      { id: "B", text: "NavLink prevents navigation." },
      { id: "C", text: "NavLink provides information about whether the link's route is currently active, which can be used for styling." },
...

  {
    ...
    options: [
      { id: "A", text: "const { productId } = useNavigate();" },
      { id: "B", text: "const { productId } = useSearchParams();" },
      { id: "C", text: "const productId = useLocation('/products/:productId');" },
      { id: "D", text: "const { productId } = useParams();" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Matching only the home page." },
      { id: "B", text: "Handling URLs that do not match the application's defined routes." },
...

  {
    ...
    options: [
      { id: "A", text: "React cannot render dashboard components." },
      { id: "B", text: "useParams automatically deleted the route." },
      { id: "C", text: "Link disables browser refresh." },
      { id: "D", text: "The server is not configured to serve the application's entry document for client-side routes." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It automatically provides backend authorization." },
      { id: "B", text: "The deployment environment cannot easily configure server fallback behavior for client-side routes." },
...

  {
    ...
    options: [
      { id: "A", text: "The fragment is always sent as part of the server request path." },
      { id: "B", text: "The fragment can only contain numbers." },
      { id: "C", text: "The fragment after # is not included in the HTTP request sent to the server." },
...

  {
    ...
    options: [
      { id: "A", text: "Put all information into the React component state and remove it from the URL." },
      { id: "B", text: "Use only a query parameter for everything regardless of semantics." },
      { id: "C", text: "Put the values inside the route component's JSX." },
      { id: "D", text: "Use a path parameter for the identity and a query parameter for the filter, such as /products/42?category=books." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It remains permanently 42 because route parameters are immutable." },
      { id: "B", text: "It should change from \"42\" to \"43\" and the matching route UI can update." },
...

  {
    ...
    options: [
      { id: "A", text: "React Router renders every Route simultaneously." },
      { id: "B", text: "React Router chooses routes randomly." },
      { id: "C", text: "React Router compares the current location against the configured route hierarchy and selects the matching branch." },
...

  {
    ...
    options: [
      { id: "A", text: "It eliminates the need for components." },
      { id: "B", text: "It forces every page to use one component." },
      { id: "C", text: "It prevents URLs from changing." },
      { id: "D", text: "It allows shared layouts, nested UI, route-specific parameters, and organized navigation to be modeled together." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Every page is opened in a separate browser tab." },
      { id: "B", text: "An admin layout stays visible while /admin/users, /admin/orders, and /admin/settings replace only the main content area." },
...

  {
    ...
    options: [
      { id: "A", text: "The fetch should always have an empty dependency array." },
      { id: "B", text: "The fetch should depend only on window.innerWidth." },
      { id: "C", text: "The data-fetching synchronization should depend on id." },
...

  {
    ...
    options: [
      { id: "A", text: "Create a route with path=\"404-only\" and expect every unknown URL to match it automatically." },
      { id: "B", text: "Use useParams to force every URL into the 404 component." },
      { id: "C", text: "Put the NotFound component inside BrowserRouter without a route." },
      { id: "D", text: "Define a fallback route such as path=\"*\" that renders a NotFound component." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Use one component for the entire application and keep every URL change in local state." },
      { id: "B", text: "Use a router with a parent admin layout, nested child routes rendered through Outlet, dynamic params for resource IDs, search params for filters, navigation APIs for redirects, and a catch-all route for unknown URLs." },
      { id: "C", text: "Use only query parameters for every route and duplicate the sidebar in every page component." },
      { id: "D", text: "Use normal anchor tags for every internal page and rely on CSS to determine which page is active." }
    ],
    correctOptionId: "B",
