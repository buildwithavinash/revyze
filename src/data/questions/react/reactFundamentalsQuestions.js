const reactFundamentalsQuestions = [
  {
    ...
    options: [
      ...
      { id: "B", text: "Creating operating system kernels." },
      { id: "C", text: "Building user interfaces from reusable components." },
      { id: "D", text: "Compiling JavaScript into machine code." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "Double parentheses" },
      { id: "B", text: "Square brackets" },
      { id: "C", text: "Angle brackets" },
      { id: "D", text: "Curly braces" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "function Welcome() { return <h1>Hello</h1>; }" },
      { id: "B", text: "component Welcome() { return <h1>Hello</h1>; }" },
      { id: "C", text: "function: Welcome() { return <h1>Hello</h1>; }" },
      { id: "D", text: "React.component Welcome() { return <h1>Hello</h1>; }" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "It automatically gives the component access to state." },
      { id: "B", text: "It allows JSX to distinguish user-defined components from intrinsic HTML elements." },
      { id: "C", text: "It prevents the component from receiving props." },
      { id: "D", text: "It converts the component into a class." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "<Child prop.title=\"Dashboard\" />" },
      { id: "B", text: "<Child -> title=\"Dashboard\" />" },
      { id: "C", text: "<Child state=\"title: Dashboard\" />" },
      { id: "D", text: "<Child title=\"Dashboard\" />" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "function User({ name }) { return <p>{name}</p>; }" },
      { id: "B", text: "function User(name.props) { return <p>{name}</p>; }" },
      { id: "C", text: "function User(state.name) { return <p>{name}</p>; }" },
      { id: "D", text: "function User(props.name) { return <p>{name}</p>; }" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "A component can only be rendered once." },
      { id: "B", text: "The same component can be used in different places with different inputs." },
      { id: "C", text: "A component cannot receive props." },
      { id: "D", text: "A component must contain all application logic." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "A component and its props." },
      { id: "B", text: "An event object and a DOM element." },
      { id: "C", text: "A route and a URL parameter." },
      { id: "D", text: "A state value and a function for updating it." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Assign a new value directly to the state variable." },
      { id: "B", text: "Call the setter function returned by useState." },
      { id: "C", text: "Modify the component function's source code." },
      { id: "D", text: "Change the component's props." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "The component is permanently removed from the page." },
      { id: "B", text: "The count variable is changed directly without a render." },
      { id: "C", text: "The state is requested to change from its current value to one greater." },
      { id: "D", text: "The browser reloads the entire page." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "<button value=\"Save\" />" },
      { id: "B", text: "<button text=\"Save\" />" },
      { id: "C", text: "<button content=\"Save\"></button>" },
      { id: "D", text: "<button>Save</button>" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "A component return expression needs a single enclosing JSX structure." },
      { id: "B", text: "React components can only render buttons." },
      { id: "C", text: "JSX does not support multiple elements." },
      { id: "D", text: "React requires every element to have a unique CSS class." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "<fragment><h1>Title</h1><p>Text</p></fragment>" },
      { id: "B", text: "<><h1>Title</h1><p>Text</p></>" },
      { id: "C", text: "<group><h1>Title</h1><p>Text</p></group>" },
      { id: "D", text: "<wrapper><h1>Title</h1><p>Text</p></wrapper>" }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "A child component should directly assign new values to its props." },
      { id: "B", text: "Props can only be passed from a child to a parent." },
      { id: "C", text: "A component should treat its props as inputs rather than directly modifying them." },
      { id: "D", text: "Props automatically persist after the application closes." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "React runs the component again to determine the UI for the updated state or props." },
      { id: "B", text: "React always reloads the browser page." },
      { id: "C", text: "React deletes the entire application and rebuilds it from scratch." },
      { id: "D", text: "React only re-renders when CSS changes." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "To encrypt the rendered element." },
      { id: "B", text: "To provide a stable identity for each item in the collection." },
      { id: "C", text: "To make the element receive keyboard input automatically." },
      { id: "D", text: "To make the element globally accessible." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "{products.render(product => <p>{product.name}</p>)}" },
      { id: "B", text: "{products.loop(product => <p>{product.name}</p>)}" },
      { id: "C", text: "{products.map(product => <p key={product.id}>{product.name}</p>)}" },
      { id: "D", text: "{products.display(product => <p>{product.name}</p>)}" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "The child automatically owns all of the parent's state." },
      { id: "B", text: "The parent can directly access every local variable inside the child." },
      { id: "C", text: "The child must always be implemented as a class." },
      { id: "D", text: "The parent can pass data to the child through props." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The paragraph containing Admin panel is rendered." },
      { id: "B", text: "Nothing inside the div is rendered." },
      { id: "C", text: "The string true is rendered instead of the paragraph." },
      { id: "D", text: "React throws an error because && cannot be used in JSX." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Data automatically flows from every child to every parent." },
      { id: "B", text: "Data generally flows from parent components toward child components through props." },
      { id: "C", text: "Every component can directly modify every other component's state." },
      { id: "D", text: "Data can only flow through browser storage." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "<h2>{user->name}</h2>" },
      { id: "B", text: "<h2>{user::name}</h2>" },
      { id: "C", text: "<h2>{user.name}</h2>" },
      { id: "D", text: "<h2>{user/name}</h2>" }
    ],
    correctOptionId: "C",
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "CSS rules that describe the interface." },
      { id: "B", text: "SQL queries that create the interface." },
      { id: "C", text: "HTML files that replace the JavaScript application." },
      { id: "D", text: "JavaScript expressions that create React elements." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "<Profile age=(user.age) />" },
      { id: "B", text: "<Profile age={user.age} />" },
      { id: "C", text: "<Profile age=[user.age] />" },
      { id: "D", text: "<Profile age={{user.age}} />" }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "The string Button through the children prop." },
      { id: "B", text: "A state variable named Save." },
      { id: "C", text: "The string Save through the children prop." },
      { id: "D", text: "No value because children is not a valid prop." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "State belongs to a component's React-managed data and can change over time." },
      { id: "B", text: "State can only contain numbers." },
      { id: "C", text: "State must always be received from a parent." },
      { id: "D", text: "State is permanently stored in the DOM." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "To read the current DOM element." },
      { id: "B", text: "To request that React update the associated state value." },
      { id: "C", text: "To define a component's props." },
      { id: "D", text: "To create a new React application." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "It remains 10 because state cannot be replaced." },
      { id: "B", text: "It changes from 10 to 30." },
      { id: "C", text: "It changes from 10 to 20 after the state update is processed." },
...

  {
    ...
    options: [
      { id: "A", text: "It is always an actual DOM node." },
      { id: "B", text: "It is always a class component instance." },
      { id: "C", text: "It is a browser event object." },
      { id: "D", text: "It is a description of what React should render." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "<Product quantity={3} />" },
      { id: "B", text: "<Product quantity=\"{3}\" />" },
      { id: "C", text: "<Product quantity=(3) />" },
      { id: "D", text: "<Product quantity=[3] />" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "The variable React Basics." },
      { id: "B", text: "React Basics as a string." },
      { id: "C", text: "An object containing title." },
      { id: "D", text: "A React state value." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "function Avatar({ size : 40 }) { return <img width={size} />; }" },
      { id: "B", text: "function Avatar({ size -> 40 }) { return <img width={size} />; }" },
      { id: "C", text: "function Avatar({ size = 40 }) { return <img width={size} />; }" },
      { id: "D", text: "function Avatar({ default size 40 }) { return <img width={size} />; }" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "The component receives its props through its function parameter." },
      { id: "B", text: "Props are available only through localStorage." },
      { id: "C", text: "Props must always be accessed through document.querySelector." },
      { id: "D", text: "Props are created automatically by CSS." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "To create a new browser window." },
      { id: "B", text: "To group multiple elements without adding an extra DOM element." },
      { id: "C", text: "To store component state." },
      { id: "D", text: "To replace every HTML element." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "JavaScript objects cannot be changed." },
      { id: "B", text: "React automatically converts objects into strings." },
      { id: "C", text: "Props can only contain primitive values." },
      { id: "D", text: "Props represent inputs from the component's owner and should be treated as read-only." }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      ...
      { id: "D", text: "<button eventClick={handleClick}>Save</button>" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "React does not support button events." },
      { id: "B", text: "handleClick is called while rendering instead of being provided as the click handler." },
      { id: "C", text: "Functions cannot be used with onClick." },
      { id: "D", text: "JSX does not support parentheses." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "The child should directly modify the parent's local variable." },
      { id: "B", text: "The child should modify the parent's props object." },
      { id: "C", text: "The parent can pass a callback function to the child through props." },
      { id: "D", text: "The child must access the parent's function scope directly." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "To show different UI depending on whether the required condition is true or false." },
      { id: "B", text: "To prevent React from using JavaScript." },
      { id: "C", text: "To permanently remove state from the component." },
      { id: "D", text: "To force every component to render simultaneously." }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "A component must choose either props or state." },
      { id: "B", text: "A component can receive props while also maintaining its own state." },
      { id: "C", text: "Props automatically become state after the first render." },
      { id: "D", text: "State can only be used by parent components." }
    ],
    correctOptionId: "B",
...

  {
    ...
    options: [
      { id: "A", text: "Components eliminate the need for JavaScript." },
      { id: "B", text: "Components guarantee that an application has no bugs." },
      { id: "C", text: "Components separate UI responsibilities into reusable and manageable pieces." },
      { id: "D", text: "Components prevent users from interacting with the interface." }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "A heading containing name." },
      { id: "B", text: "A heading containing props." },
      { id: "C", text: "Nothing because props cannot be accessed through an object." },
      { id: "D", text: "A heading containing Avi." }
    ],
    correctOptionId: "D",
