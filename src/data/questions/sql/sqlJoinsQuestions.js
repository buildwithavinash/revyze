...
const sqlJoinsQuestions = [
  {
    ...
    options: [
      ...
      { id: "B", text: "To combine related data from multiple tables" },
      { id: "C", text: "To delete duplicate records" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Every row from the right table" },
      { id: "C", text: "Only unmatched rows from both tables" },
...

  {
    ...
    options: [
      { id: "A", text: "users.id = orders.user_id" },
      { id: "B", text: "users.name = orders.total" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "An empty result for those unmatched rows" },
      { id: "C", text: "All rows from the right table" },
...

  {
    ...
    options: [
      ...
      { id: "C", text: "LEFT JOIN customers → orders" },
      { id: "D", text: "CROSS JOIN customers → orders" }
    ],
    correctOptionId: "C",
    explanation:
...

  {
    ...
    options: [
      { id: "A", text: "Returning only duplicate rows" },
      { id: "B", text: "Filtering NULL values" },
      { id: "C", text: "Grouping related records" },
      { id: "D", text: "Producing every possible combination of rows between two tables" }
    ],
    correctOptionId: "D",
    explanation:
...

  {
    ...
    options: [
      { id: "A", text: "No matching row existed in the right table" },
      { id: "B", text: "The left row was deleted" },
...

  {
    ...
    options: [
      { id: "A", text: "SELECT * FROM employees JOIN departments;" },
      { id: "B", text: "SELECT * FROM employees INNER JOIN departments ON employees.department_id = departments.id;" },
      { id: "C", text: "SELECT * FROM employees INNER JOIN departments WHERE employees.department_id = departments.id;" },
      { id: "D", text: "SELECT * FROM employees GROUP JOIN departments ON department_id;" }
    ],
    correctOptionId: "B",
    explanation:
...

  {
    ...
    options: [
      ...
      { id: "C", text: "One row can legitimately match multiple related rows in another table" },
      { id: "D", text: "Indexes create duplicate rows" }
    ],
    correctOptionId: "C",
    explanation:
...

  {
    ...
    options: [
      { id: "A", text: "INNER JOIN customers and orders, then filter" },
      { id: "B", text: "RIGHT JOIN orders to customers and filter WHERE customers.id IS NOT NULL" },
      { id: "C", text: "CROSS JOIN both tables and count rows" },
      { id: "D", text: "LEFT JOIN customers to orders and filter WHERE orders.id IS NULL" }
    ],
    correctOptionId: "D",
    explanation:
