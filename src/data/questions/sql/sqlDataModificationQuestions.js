const sqlDataModificationQuestions = [
...

  {
    ...
    options: [
      ...
      { id: "B", text: "INSERT INTO users (name, email) VALUES ('Ava', 'ava@example.com');" },
      { id: "C", text: "ADD INTO users (name, email) VALUES ('Ava', 'ava@example.com');" },
...

  {
    ...
    options: [
      { id: "A", text: "It automatically creates indexes" },
      { id: "B", text: "It prevents all constraint violations" },
      { id: "C", text: "It makes the insert independent of column order and makes the intended values clearer" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "A new user with id 42 is created" },
      { id: "C", text: "All users except id 42 are deleted" },
      { id: "D", text: "The user with id 42 is targeted for deletion" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "CHANGE users email TO 'new@example.com' WHERE id = 15;" },
      { id: "B", text: "MODIFY users email = 'new@example.com' FOR id = 15;" },
      { id: "C", text: "UPDATE users SET email = 'new@example.com' WHERE id = 15;" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "It automatically generates a random value" },
      { id: "C", text: "It ignores the constraint" },
      { id: "D", text: "It may fail because the required value is missing" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Deletes the database schema" },
      { id: "C", text: "Undoes uncommitted changes in the current transaction" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "ROLLBACK → UPDATE → BEGIN" },
      { id: "C", text: "UPDATE → DROP → COMMIT" },
      { id: "D", text: "BEGIN → UPDATE → COMMIT" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "They can ensure the debit and credit operations are treated as one unit of work" },
      { id: "B", text: "They guarantee that both accounts use the same password" },
      { id: "C", text: "They prevent the database from storing numeric values" },
...

  {
    ...
    options: [
      { id: "A", text: "Restore every database backup ever created" },
      { id: "B", text: "Reverse the uncommitted changes in that transaction" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Every table must have one column" },
      { id: "C", text: "A transaction's operations are treated as an all-or-nothing unit" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Every transaction takes exactly one second" },
      { id: "C", text: "All tables must have identical schemas" },
      { id: "D", text: "The database moves between valid states according to its defined rules and constraints" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Control over how concurrent transactions interact with each other's changes" },
      { id: "B", text: "A way to prevent tables from ever being joined" },
      { id: "C", text: "A guarantee that every query is read-only" },
...

  {
    ...
    options: [
      { id: "A", text: "The transaction can always be rolled back from any future session" },
      { id: "B", text: "The committed changes are intended to survive subsequent failures according to the database's durability guarantees" },
...

  {
    ...
    options: [
      { id: "A", text: "INSERT MANY users ('A', 'B', 'C');" },
      { id: "B", text: "MULTIINSERT users VALUES ('A', 'B', 'C');" },
      { id: "C", text: "ADD ROWS users ('A'), ('B'), ('C');" },
      { id: "D", text: "INSERT INTO users (name) VALUES ('A'), ('B'), ('C');" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It can reduce statement and network overhead" },
      { id: "B", text: "It always bypasses constraints" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "It does nothing" },
      { id: "C", text: "It deletes all rows from the target table" },
...

  {
    ...
    options: [
      { id: "A", text: "UPDATE users CHANGE name = 'Mia' AND age = 25 WHERE id = 7;" },
      { id: "B", text: "MODIFY users name = 'Mia', age = 25;" },
      { id: "C", text: "UPDATE users COLUMNS name, age VALUES ('Mia', 25);" },
      { id: "D", text: "UPDATE users SET name = 'Mia', age = 25 WHERE id = 7;" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "To mark a point that can be rolled back to without necessarily undoing the entire transaction" },
      { id: "B", text: "To create a permanent backup of the entire database" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "So indexes are automatically removed" },
      { id: "C", text: "So the transfer is not partially applied if one operation fails" },
...

  {
    ...
    options: [
      { id: "A", text: "The database always creates two primary keys" },
      { id: "B", text: "The table is automatically deleted" },
      { id: "C", text: "Both transactions are guaranteed to see identical results" },
      { id: "D", text: "Concurrency-related anomalies may occur depending on the database and isolation level" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The affected data may violate constraints such as UNIQUE, NOT NULL, or foreign-key rules" },
      { id: "B", text: "The SQL engine cannot execute UPDATE statements" },
...

  {
    ...
    options: [
      { id: "A", text: "The database silently removes the existing duplicate" },
      { id: "B", text: "The database generally rejects the violating change" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Foreign keys apply only to SELECT queries" },
      { id: "C", text: "The foreign-key constraint may prevent creating orphaned child records" },
...

  {
    ...
    options: [
      { id: "A", text: "Deleting a child creates a new parent" },
      { id: "B", text: "All DELETE statements are permanently disabled" },
      { id: "C", text: "The foreign key is converted into a primary key" },
      { id: "D", text: "Deleting a referenced parent can automatically delete related child rows" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It guarantees no rows will ever be changed" },
      { id: "B", text: "It disables indexes automatically" },
      { id: "C", text: "It can reduce transaction size, lock duration, and resource pressure depending on the workload" },
...

  {
    ...
    options: [
      { id: "A", text: "DELETE removes the database, while DROP removes rows" },
      { id: "B", text: "They always have exactly the same effect" },
      { id: "C", text: "DROP TABLE only changes one row" },
      { id: "D", text: "DELETE removes rows, while DROP TABLE removes the table object itself" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "TRUNCATE is generally intended to remove all rows efficiently while retaining the table structure" },
      { id: "B", text: "TRUNCATE always updates every row individually" },
...

  {
    ...
    options: [
      { id: "A", text: "It guarantees every table has the same number of rows" },
      { id: "B", text: "It can help ensure the related changes are committed consistently as one logical operation" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "A failed INSERT caused by a missing column" },
      { id: "C", text: "A situation where one concurrent update overwrites another update unintentionally" },
...

  {
    ...
    options: [
      { id: "A", text: "Always omit WHERE" },
      { id: "B", text: "Use ORDER BY instead of WHERE" },
      { id: "C", text: "Drop the primary key first" },
      { id: "D", text: "Use a precise WHERE condition based on a unique identifier" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "It automatically creates product records" },
      { id: "B", text: "It allows the application to ensure the order and its required items are treated as one logical operation" },
...

  {
    ...
    options: [
      { id: "A", text: "Its changes are guaranteed to disappear after the connection closes" },
      { id: "B", text: "Its changes can always be undone with ROLLBACK in a new transaction" },
      { id: "C", text: "Its changes are no longer treated as uncommitted work that can be reversed by a normal rollback of that transaction" },
...

  {
    ...
    options: [
      { id: "A", text: "It makes SELECT syntax invalid" },
      { id: "B", text: "It automatically drops unused tables" },
      { id: "C", text: "It prevents all indexes from existing" },
      { id: "D", text: "It can hold locks or transactional resources longer and increase contention" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Investigate the condition and, if still uncommitted, consider rolling back the transaction" },
      { id: "B", text: "Continue because the database already accepted the query" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Identify and preview the target rows, use a precise condition, perform the change in an appropriate transaction, verify the result, then commit" },
      { id: "C", text: "Disable constraints, modify everything, and restart the database" },
