const cssGridQuestions = [
  {
    ...
    options: [
      { id: "A", text: "display: css-grid;" },
      { id: "B", text: "grid: container;" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "Only elements with display: block" },
      { id: "C", text: "Only elements explicitly assigned grid-column" },
      { id: "D", text: "The direct children of the grid container" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Two columns, each 200px" },
      { id: "B", text: "One 200px row and two flexible rows" },
      { id: "C", text: "Three columns: one 200px column and two equal flexible columns" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "A percentage of the viewport" },
      { id: "C", text: "A font-relative unit" },
      { id: "D", text: "A fraction of the available grid space" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "To repeat an animation" },
      { id: "B", text: "To repeat a track-size pattern multiple times" },
...

  {
    ...
    options: [
      { id: "A", text: "Adds margin around the grid container" },
      { id: "B", text: "Changes the width of every grid item" },
      { id: "C", text: "Creates gutters between grid rows and columns" },
...

  {
    ...
    options: [
      { id: "A", text: "Adds 20px margin around every grid item" },
      { id: "B", text: "Adds 20px padding to the container" },
      { id: "C", text: "Sets all grid tracks to 20px" },
      { id: "D", text: "Creates a 20px gap between grid rows and columns" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Starts at column 2 and ends at line 1" },
      { id: "B", text: "Starts at column line 1 and spans two columns" },
...

  {
    ...
    options: [
      { id: "A", text: "grid-names" },
      { id: "B", text: "grid-area-template" },
...

  {
    ...
    options: [
      { id: "A", text: "grid-areas: header header header;" },
      { id: "B", text: "grid-template: header header header;" },
      { id: "C", text: "grid-names: \"header header header\";" },
      { id: "D", text: "grid-template-areas: \"header header header\";" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "A wildcard area" },
      { id: "B", text: "An empty grid cell" },
...

  {
    ...
    options: [
      ...
      { id: "B", text: "align-grid" },
      { id: "C", text: "grid-items-align" },
...

  {
    ...
    options: [
      { id: "A", text: "They always perform exactly the same operation" },
      { id: "B", text: "justify-content aligns text and justify-items changes columns" },
      { id: "C", text: "justify-items aligns items within their cells, while justify-content distributes the grid tracks within the container" },
...

  {
    ...
    options: [
      { id: "A", text: "Changes the grid's row count" },
      { id: "B", text: "Changes the item's grid area name" },
      { id: "C", text: "Changes the grid container into Flexbox" },
      { id: "D", text: "Overrides the container's align-items value for that individual grid item" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "The size of all explicitly declared rows" },
      { id: "B", text: "The size of automatically created rows" },
...

  {
    ...
    options: [
      { id: "A", text: "The size of all explicit columns" },
      { id: "B", text: "The number of columns" },
      { id: "C", text: "The size of automatically created columns" },
...

  {
    ...
    options: [
      { id: "A", text: "The explicit grid uses Flexbox and the implicit grid uses Grid" },
      { id: "B", text: "The implicit grid is always smaller" },
      { id: "C", text: "There is no difference" },
      { id: "D", text: "The explicit grid is defined by grid-template properties, while the implicit grid is created automatically as needed" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Make every grid track smaller" },
      { id: "B", text: "Increase the grid gap" },
      { id: "C", text: "Fill earlier available gaps with later auto-placed items when possible" },
...

  {
    ...
    options: [
      { id: "A", text: "Defines the minimum and maximum number of grid items" },
      { id: "B", text: "Sets the minimum and maximum gap" },
      { id: "C", text: "Creates two grid containers" },
      { id: "D", text: "Defines a minimum and maximum size for a grid track" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "auto-fit only works vertically" },
      { id: "B", text: "auto-fit can collapse empty repeated tracks, while auto-fill preserves the available track slots" },
...

  {
    ...
    options: [
      { id: "A", text: "grid-template-columns: repeat(2, 1fr);" },
      { id: "B", text: "grid-rows: 2fr;" },
      { id: "C", text: "grid-template-rows: repeat(2, 1fr);" },
...

  {
    ...
    options: [
      { id: "A", text: "grid-column: 4 / 1;" },
      { id: "B", text: "grid-column: span 4 / 1;" },
      { id: "C", text: "grid-column: all;" },
      { id: "D", text: "grid-column: 1 / -1;" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "grid-area: 1 / 2 / 3 / 4;" },
      { id: "B", text: "grid-area: 2 / 1 / 4 / 3;" },
...

  {
    ...
    options: [
      { id: "A", text: "It forces the column to be exactly 0px" },
      { id: "B", text: "It disables text wrapping" },
      { id: "C", text: "It allows the track's minimum size to shrink to zero instead of being constrained by its automatic minimum" },
...

  {
    ...
    options: [
      { id: "A", text: "Set z-index to -9999" },
      { id: "B", text: "Use justify-content: fixed" },
      { id: "C", text: "Set grid-template-columns to auto for every column" },
      { id: "D", text: "Consider using minmax(0, 1fr) for the flexible track and appropriate overflow or text-wrapping rules" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "Only grid-auto-flow: dense" },
      { id: "B", text: "Named grid areas with grid-template-areas" },
...

  {
    ...
    options: [
      { id: "A", text: "grid-template-areas: \"header sidebar\" \"header main\" \"footer footer\";" },
      { id: "B", text: "grid-template-areas: header header sidebar main footer footer;" },
      { id: "C", text: "grid-template-areas: \"header header\" \"sidebar main\" \"footer footer\";" },
      { id: "D", text: "grid-areas: \"header header\" \"sidebar main\" \"footer footer\";" }
    ],
    correctOptionId: "C",
...

  {
    ...
    options: [
      { id: "A", text: "It always places every item in the first cell" },
      { id: "B", text: "It only works when grid-template-areas is used" },
      { id: "C", text: "It requires every item to have grid-column and grid-row" },
      { id: "D", text: "It automatically places grid items into available cells when explicit placement is not provided" }
    ],
    correctOptionId: "D",
...

  {
    ...
    options: [
      { id: "A", text: "grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));" },
      { id: "B", text: "grid-template-columns: repeat(250px, auto-fit);" },
      { id: "C", text: "grid-template-columns: 250px;" },
      { id: "D", text: "grid-auto-flow: fixed;" }
    ],
    correctOptionId: "A",
...

  {
    ...
    options: [
      { id: "A", text: "Only when there is one element" },
      { id: "B", text: "When the layout needs coordinated control over both rows and columns" },
...

  {
    ...
    options: [
      { id: "A", text: "1fr always means exactly 33.33%" },
      { id: "B", text: "Grid ignores content size completely" },
      { id: "C", text: "A flexible track can still be affected by the item's intrinsic minimum size" },
...

  {
    ...
    options: [
      { id: "A", text: "Use absolute positioning for every grid item and manually calculate every coordinate" },
      { id: "B", text: "Use only fixed pixel columns so the layout cannot change" },
      { id: "C", text: "Create a separate grid container for every individual element" },
      { id: "D", text: "Use explicit tracks or named areas where structure matters, auto-placement where appropriate, minmax()/fr for flexible sizing, gap for gutters, and deliberate item/track alignment" }
    ],
    correctOptionId: "D",
